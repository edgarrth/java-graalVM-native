...
import com.axiz.poc.payments.application.port.in.AuthorizePaymentUseCase;
...
public class PaymentController__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<PaymentController> getPaymentControllerInstanceSupplier() {
    return BeanInstanceSupplier.<PaymentController>forConstructor(AuthorizePaymentUseCase.class)
