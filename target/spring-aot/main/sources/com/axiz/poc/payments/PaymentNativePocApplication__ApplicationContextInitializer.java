 ...
 */
@Generated
public class PaymentNativePocApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new PaymentNativePocApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new PaymentNativePocApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
